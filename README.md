# COSC522<img src='https://github.com/drkostas/COSC522.git/blob/master/img/snek.png' align='right' width='180' height='104'>

[![CircleCI](https://circleci.com/gh/drkostas/cosc522/tree/master.svg?style=svg)](https://circleci.com/gh/drkostas/cosc522/tree/master)
...
+ [Running locally](#run_locally)
    ...
    + [Execution Options](#execution_options)
        + [COSC522 Main](#cosc522_main)
        + [COSC522 Greet CLI](#cosc522_cli)
...
In order to run the [main.py](cosc522/main.py)  you will need to set the
...
$ which python
/home/drkostas/anaconda3/envs/cosc522/bin/python

```

#### COSC522 Main <a name = "cosc522"></a>

Now, in order to run the code you can either call the [main.py](cosc522/main.py)
directly, or invoke the `cosc522_main`
console script.

```ShellSession
$ python cosc522/main.py --help
...
#### COSC522 CLI <a name = "cosc522_cli"></a>

There is also a [cli.py](cosc522/cli.py) which you can also invoke it by its
console script too
(`cli`).
